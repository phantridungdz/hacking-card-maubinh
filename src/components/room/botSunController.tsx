...
import useBotSunWebSocket from '../../hooks/useBotSunWebSocket';
import { Card } from '../ui/card';

export const BotSunController: React.FC<any> = ({ bot, roomID }) => {
  const { connectionStatus, botMoneyChange } = useBotSunWebSocket(bot, roomID);
