import useWaiterSunWebSocket from 'hooks/useWaiterSunWebSocket';
import { Clock, DollarSign } from 'lucide-react';
import { Card } from '../ui/card';

export const WaiterSunController: React.FC<any> = ({ bot, roomID }) => {
  const { connectionStatus, botMoneyChange } = useWaiterSunWebSocket(
    bot,
    roomID
  );
  return (
